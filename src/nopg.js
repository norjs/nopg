...
export class NoPg {
	...
	constructor(db) {
		...
		this.deleteType = NoPg.prototype.delType;
		/* Start of Method Implementation */
		this.deleteMethod = NoPg.prototype.delMethod;
		/* Start of View Implementation */
		this.deleteView = NoPg.prototype.delView;
